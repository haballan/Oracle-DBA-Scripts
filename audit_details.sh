...
echo
echo "Enter The USERNAME you want to retrieve it's Audit Data: [Blank Value means ALL Users]"
echo "======================================================="
...
select extended_timestamp,OS_USERNAME,USERNAME,USERHOST,SQL_TEXT
