###################################################
# This script check last logon time for EACH User.
...
echo
echo "===================================================================="
echo "This script check the last logon time for EACH User on the database."
echo "===================================================================="
echo
sleep 1
...
###########################
echo "Please Enter the Username: [Blank value will list ALL Users]"
echo "========================="
read USERNAME
	if [ -z "${USERNAME}" ]
	 then
