...
col USERNAME for a30
col account_status for a23
select a.username,a.account_status,a.profile,q.tablespace_name,q.bytes/1024/104 USED_MB, q.max_bytes "MAX_QUOTA_Bytes" from dba_users a, dba_ts_quotas q where a.username=q.username and a.username like upper ('%$USERNAME%');
set pages 0
set echo off heading off feedback off
spool '$SPOOL_FILE'
PROMPT
