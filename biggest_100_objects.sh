# #################################################
# Script to shows the biggest 100 objects on the DB	
#					#   #     #
...
echo
echo "==================================================="
echo "This script shows the biggest 100 objects on the DB."
echo "==================================================="
echo
sleep 1
...
# ######################################
# SQLPLUS: Retreiving Biggest 100 Object:
# ######################################
...
PROMPT Retrieving the Biggest 100 Objects:
PROMPT ----------------------------------

Select * from (select OWNER,SEGMENT_NAME,SEGMENT_TYPE,TABLESPACE_NAME,BYTES/1024/1024 SIZE_MB from dba_segments order by 5 desc)where rownum <101 order by 5; 
EOF
